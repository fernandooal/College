...
public class Main {
	...
	public static void checkWinner(int jogadorJogadaPosicao, Jogada jogadaComputador) {
		if(jogadorJogadaPosicao == jogadaComputador.getValor()) {
			...
			if(jogadorJogadaPosicao > jogadaComputador.getValor()) {
				System.out.println("Parabéns, você ganhou!!"); //jogador ganhou (pedra - papel)
			} else if(jogadaComputador.getValor() == 3) {
				if(jogadorJogadaPosicao == 1) {
					System.out.println("Parabéns, você ganhou!"); //jogador ganhou (tesoura - pedra)
				} else {
			...
			if(jogadaComputador.getValor() == 1) {
				...
				System.out.println("Parabéns, você ganhou!!"); //jogador ganhou (papel - tesoura)
			}
		}
	}
}
